...
EE_OBJS += title_cfg.o esr_elf.o fmcbd_elf.o boot2_elf.o boot_elf.o icon_sys.o copy_icn.o del_icn.o boot_icn.o config_ini.o OpenTuna_sys.o OpenTuna_SLIMS.o OpenTuna_FAT-170.o \
...
EE_SRC = title_cfg.s esr_elf.s fmcbd_elf.s boot2_elf.s boot_elf.s icon_sys.s copy_icn.s del_icn.s boot_icn.s config_ini.s OpenTuna_sys.s  OpenTuna_SLIMS.s OpenTuna_FAT-170.s \
	OpenTuna_FAT-110-120-150-160.s PADMAN_irx.c SIO2MAN_irx.c MCMAN_irx.c MCSERV_irx.c ldrfmcbdicon_sys.s ldrfmcbdfmcb_icn.s ldrfmcbddel_icn.s ldrfmcbdcopy_icn.s \
	fmcbcfgcopy_icn.s fmcbcfgdel_icn.s fmcbcfgicon_sys.s fmcbcfglist_icn.s sysconffmcb_cfg_elf.s sysconffreemcb_cnf.s sysconfipconfig_dat.s sysconflaunchelf_cnf.s \
	sysconfps2bbl_ini.s sysconfusbd_irx.s sysconfusbhdfsd_irx.s sysconfcopy_icn.s sysconfdel_icn.s sysconfendvdpl_irx.s sysconficon_sys.s sysconfsysconf_icn.s
